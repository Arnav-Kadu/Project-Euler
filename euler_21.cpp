...
void solve()
{
   // d(n) = sum of all proper divisor
   // to find sum of amicable numbers under 10000
   unordered_set<int> amicable_numbers;
    int sum = 0;

    for (int a = 2; a <=10000; a++) {
        if (amicable_numbers.find(a) == amicable_numbers.end()) {
            int b = sumOfDivisors(a);
            if (b != a && b < 10000 && sumOfDivisors(b) == a) {
